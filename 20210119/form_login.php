		...
		<div class="modal">
			...
			<form id="f1" class="modal-content animate" action="autenticacao.php" method="post">
				...
				<div class="container">
					...
					<input type="text" placeholder="Digite seu e-mail" name="email" value="<?php echo isset($_COOKIE[NOME_COOKIE])?base64_decode($_COOKIE[NOME_COOKIE]):'';?>" required id="email"/>

					<!--<input type="text" placeholder="Digite seu e-mail" name="email"

								if(isset($_COOKIE["email"])){
										//mostrar o email no input
										$email = $_COOKIE["email"];
										echo 'value="'.$email.'"';
								}
