            ...
            echo '
                <div class = "container">
                    ...
                    <form action="form_estado.php" method="POST">
                        <div class="row">
                            <div class="col-2">
                                <label for="nomeEstado" class="col-2">
                                    Nome do estado:
                                </label>
                            </div>
                            <div class="col-5">
                                <input type="text" id="nomeEstado" name="nome" class="form-control" max="100" placeholder="Nome" required>
                            </div>
                            <div class="col-2">
                                <label for="sigla" class="col-2">
                                    Sigla do estado:
                                </label>
                            </div>
                            <div class="col-3">
                                <input type="text" id="sigla" name="sigla" max="3" class="form-control" placeholder="Sigla" max="2">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2">
                                <label for="inputEstado" class="col-2">
                                    País:
                                </label>
                            </div>
                            <div class="col">
